...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    public function getAreaServe() {
        $storeId = $this->_storeManager->getStore()->getId();
        $store = $this->getStoreView();
        return $this->_filterProvider->getBlockFilter()->setStoreId($storeId)->filter($store->getAreaServe());
    }

    public function getOurPricing() {
        $storeId = $this->_storeManager->getStore()->getId();
        $store = $this->getStoreView();
        return $this->_filterProvider->getBlockFilter()->setStoreId($storeId)->filter($store->getOurPricing());
    }
    ...
    public function getTestimonials() {
        $storeId = $this->_storeManager->getStore()->getId();
        $store = $this->getStoreView();
        return $this->_filterProvider->getBlockFilter()->setStoreId($storeId)->filter($store->getTestimonials());
    }

    public function getGalleryImages() {
        $storeId = $this->_storeManager->getStore()->getId();
        $store = $this->getStoreView();
        return $this->_filterProvider->getBlockFilter()->setStoreId($storeId)->filter($store->getGalleryImages());
    }
