<?php
namespace MGS\StoreLocator\Block\Adminhtml\Locator\Edit\Tab\MetaTag;

/**
 * Interceptor class for @see \MGS\StoreLocator\Block\Adminhtml\Locator\Edit\Tab\MetaTag
 */
class Interceptor extends \MGS\StoreLocator\Block\Adminhtml\Locator\Edit\Tab\MetaTag implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, \Magento\Directory\Model\Config\Source\Country $countryFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $registry, $formFactory, $countryFactory, $data);
    }
